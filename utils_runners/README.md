...
> Note: the **NLR-based TTE (Cohort A)** is run by invoking the same TTE
> core script with NLR cohort IDs as the second CLI argument
> (see `07_target_trial_emulation/README.md`).
