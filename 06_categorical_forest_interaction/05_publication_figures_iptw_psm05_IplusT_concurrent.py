...
"""
============================================================================
IPTW 敏感性分析：HAIC alone vs HAIC+I+T concurrent — 发表级森林图（Fig4 + Landmark 补充）
============================================================================
队列：原始全队列（非 PSM 匹配），仅筛选 HAIC_alone 与 HAIC+I+T_concurrent 两组；
  使用 stabilized IPTW 加权平衡基线差异。
  数据源同 03_publication_figures_ids05_IplusT_concurrent.py：HAIC_NO_TACE_4_TIDY_baseline + longitudinal。
...
产出（输出至 psm05_HAIC_IplusT_concurrent_IPTW/）：
...
OUT_DIR    = os.path.join(PROJECT_ROOT, 'output', 'step2_interaction_forest', 'psm05_HAIC_IplusT_concurrent_IPTW')
...
GROUP_2 = 'HAIC+I+T_concurrent'   # 治疗组 (treatment=1)

OUT_PREFIX = 'iptw_psm05_HAIC_IplusT_concurrent'
